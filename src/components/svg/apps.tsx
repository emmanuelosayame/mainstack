export const Invoicing = ({ disabled = false }: { disabled?: boolean }) => {
  return (
    <svg
      width={disabled ? '21' : '24'}
      height={disabled ? '21' : '24'}
      viewBox='0 0 24 24'
      fill='none'
      ...
      <g id='Product Icons'>
        <path
          ...
          fill={disabled ? 'gray' : 'url(#paint0_linear_5416_1465)'}
        />
        <path
          id='Vector_2'
          ...
          fill={disabled ? 'gray' : 'url(#paint1_linear_5416_1465)'}
        />
        <path
          id='Vector_3'
          ...
          fill={disabled ? 'gray' : 'url(#paint2_linear_5416_1465)'}
        />
      </g>
      <defs>
        <linearGradient
          id='paint0_linear_5416_1465'
          x1='8.2422'
          y1='13.8522'
          x2='20.5182'
          y2='13.8522'
...
export const MediaKit = ({ disabled = false }: { disabled?: boolean }) => {
  return (
    <svg
      width={disabled ? '21' : '20'}
      height={disabled ? '21' : '20'}
      viewBox='0 0 20 20'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'>
      <g id='vector'>
        <path
          ...
          fill={disabled ? 'gray' : 'url(#paint0_linear_5416_1460)'}
        />
        <path
          id='Vector_2'
          ...
          fill={disabled ? 'gray' : 'url(#paint1_linear_5416_1460)'}
        />
        <path
          id='Vector_3'
          ...
          fill={disabled ? 'gray' : 'url(#paint2_linear_5416_1460)'}
        />
      </g>
      <defs>
        <linearGradient
          id='paint0_linear_5416_1460'
          x1='2.27548'
          y1='5.14244'
          x2='13.8365'
          y2='5.14244'
...
export const Store = ({ disabled = false }: { disabled?: boolean }) => {
  return (
    <svg
      width={disabled ? '21' : '20'}
      height={disabled ? '21' : '22'}
      viewBox='0 0 20 22'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'>
      <g id='vector'>
        <path
          ...
          fill={disabled ? 'gray' : 'url(#paint0_linear_5416_1454)'}
        />
        <path
          id='Vector_2'
          ...
          fill={disabled ? 'gray' : 'url(#paint1_linear_5416_1454)'}
        />
        <path
          id='Vector_3'
          ...
          fill={disabled ? 'gray' : 'url(#paint2_linear_5416_1454)'}
        />
      </g>
      <defs>
        <linearGradient
          id='paint0_linear_5416_1454'
          x1='2.34182'
          y1='13.4112'
          x2='17.6375'
          y2='13.4112'
...
export const LinkInBio = ({ disabled = false }: { disabled?: boolean }) => {
  return (
    <svg
      width={disabled ? '21' : '24'}
      height={disabled ? '21' : '24'}
      ...
      <g id='Product Icons'>
        ...
        <path
          ...
          fill={disabled ? 'gray' : 'url(#paint2_linear_5416_1448)'}
        />
      </g>
      <defs>
        <linearGradient
          id='paint0_linear_5416_1448'
          x1='2.89818'
          y1='8.44539'
          x2='18.1055'
          y2='8.44539'
